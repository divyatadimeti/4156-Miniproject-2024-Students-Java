...
public class RouteController {
  ...
  private static final String ATTR_UPDATED = "Attribute was updated successfully.";
  ...
  */
  ...
  public ResponseEntity<?> retrieveCourse(@RequestParam(value = DEPT_CODE) String deptCode,
  ...
  */
  ...
  public ResponseEntity<?> isCourseFull(@RequestParam(value = DEPT_CODE) String deptCode,
                                        @RequestParam(value = COURSE_CODE) int courseCode) {
    try {
  ...
  */
  ...
  public ResponseEntity<?> findCourseLocation(@RequestParam(value = DEPT_CODE) String deptCode,
                                              @RequestParam(value = COURSE_CODE) int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  */
  ...
  public ResponseEntity<?> findCourseTime(@RequestParam(value = DEPT_CODE) String deptCode,
                                          @RequestParam(value = COURSE_CODE) int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  */
  ...
  public ResponseEntity<?> dropStudent(@RequestParam(value = DEPT_CODE) String deptCode,
                                       @RequestParam(value = COURSE_CODE) int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  */
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam(value = DEPT_CODE) String deptCode,
                                              @RequestParam(value = COURSE_CODE) int courseCode,
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>(ATTR_UPDATED, HttpStatus.OK);
      } else {
        return new ResponseEntity<>(COURSE_NOT_FOUND, HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {
  ...
  * This method handles PATCH requests to change the time of a
  *     course identified by
  *     department code and course code.If the course exists,
  *     its time is updated to the provided time.
  *
  ...
  */
  ...
  public ResponseEntity<?> changeCourseTime(@RequestParam(value = DEPT_CODE) String deptCode,
                                            @RequestParam(value = COURSE_CODE) int courseCode,
  ...
  */
  ...
  public ResponseEntity<?> changeCourseTeacher(@RequestParam(value = DEPT_CODE) String deptCode,
                                               @RequestParam(value = COURSE_CODE) int courseCode,
