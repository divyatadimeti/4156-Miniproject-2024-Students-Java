...
public class MyFileDatabaseTests {
    ...
    public void test_setMapping() {
        ...
        Department department = new Department("COMS", courses, "Luca Carloni", 2700);
    ...
    @Test
    public void test_setMapping_NullMapping() {
        myFileDatabase.setMapping(null);
        assertNull(myFileDatabase.getDepartmentMapping(), "Dept mapping should be null when mapping set to null.");
    }
    ...
    public void test_serialize_deserialize() {
        HashMap<String, Course> courses = new HashMap<>();
        Course course = new Course("Waseem Noor", "309 HAV", "2:40-3:55", 210);
        courses.put("econ1105", course);

        Department department = new Department("ECON", courses, "Michael Woodford", 2345);
        HashMap<String, Department> departments = new HashMap<>();
        ...
        assertEquals(departments.size(), deserializedDepartments.size(), "Dept size should match.");
        ...
        assertEquals("Michael Woodford", deserializedDepartment.getDepartmentChair(), "Dept chair should match.");
        assertEquals(2345, deserializedDepartment.getNumberOfMajors(), "Num majors should match.");
    }
    ...
    public void test_getDeptMapping_FilePathHandling() {
        ...
        assertEquals(new HashMap<>(), databaseWithInvalidPath.getDepartmentMapping(), "Dept mapping should be empty hashmap for invalid file path.");
    }

    @Test
    public void test_toString() {
        HashMap<String, Course> courses = new HashMap<>();
        Course course = new Course("Uday Menon", "627 MUDD", "11:40-12:55", 50);
        courses.put("ieor2500", course);

        Department department = new Department("IEOR", courses, "Jay Sethuraman", 67);
        HashMap<String, Department> departments = new HashMap<>();
